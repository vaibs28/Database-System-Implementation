...
// reading the paths from Constants.h header file
 char *dbfile_dir = DBFILE_PATH; // dir where binary heap files should be stored
 char *tpch_dir = TPCH_PATH; // dir where dbgen tpch files (extension *.tbl) can be found
...
void test1() {
    ...
    char tbl_path[2100]; // construct path of the tpch flat text file
...
int main() {
    ...
    void (*test)();
    relation *rel_ptr[] = {n, r, c, p, ps, o, li,s , m};
